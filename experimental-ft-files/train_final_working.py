#!/usr/bin/env python3
"""
Final working training script with proper LoRA setup
"""
...
def main():
    ...
    try:
        logger.info("="*60)
        logger.info("FINAL WORKING TRAINING")
        logger.info("="*60)
        ...
        # Setup LoRA with proper configuration
        ...
        logger.info(f"📊 Number of trainable parameters: {len(trainable_params_list)}")
        ...
        training_args = TrainingArguments(
            ...
            gradient_checkpointing=False,  # Disable gradient checkpointing to avoid issues
