...
def generate_nsduh_data_batched(
    data: pd.DataFrame,
    model,
    tokenizer,
    device,
...
if __name__ == "__main__":
    ...
    #     "Generate a short story about a person who is {age} years of age, "
    #     "who is {sex}, who is {race}, who completed {edu}. "
    #     "This person has {cig_monthly} used cigarettes in the last month. "
    #     "This person has {mj_ever} used marijuana. "
    #     "This person has {coc_ever} used cocaine. "
